...
public class task_3_9 {
         ...
         */
        static RequestHandler commonRequestHandler = wrapInRequestTag.combineHandler(createDigest).combineHandler(wrapInTransactionTag);
        ...
        interface RequestHandler {
            ...
            default RequestHandler combineHandler(RequestHandler rh) {
                return (x) -> handle(rh.handle(x));
            }
